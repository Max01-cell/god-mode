...
/**
 * Notify the owner (maxh707@gmail.com) when the AI agent captures a lead on a cold call.
 */
export async function sendColdCallLeadNotification({ businessName, email, ownerName, phone }) {
  await sendEmail({
    to: 'maxh707@gmail.com',
...
/**
 * Notify the owner (maxh707@gmail.com) that a new merchant application came in.
