...
export async function sendSavingsReport(lead, savingsData) {
  ...
  const hiddenFeesSection = junkFeeRows ? `
    <div style="margin:28px 0 0;">
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14px;">
        ...
        <tbody>${junkFeeRows}</tbody>
      </table>
      <p style="margin:10px 0 0;font-size:14px;font-weight:600;color:#c0392b;">
        You're paying ${fmt(junkTotal)}/month in unnecessary fees.
      </p>
    </div>` : '';
