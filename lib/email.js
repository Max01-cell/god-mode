...
export async function sendSavingsReport(lead, savingsData) {
  ...
  const hiddenFeesRows = (savingsData.hidden_fees ?? []).map(f => `
    <tr>
  ...
  const hiddenFeesSection = hiddenFeesRows ? `
    <div style="margin:28px 0 0;">
      <h3 style="margin:0 0 10px;font-size:15px;color:#333;">Hidden Fees We Found</h3>
      ...
      <p style="margin:8px 0 0;font-size:13px;color:#888;">These fees go away entirely when you switch.</p>
    </div>` : '';
          ...
          <td style="padding:32px 36px;">
            ...
            <table style="width:100%;border-collapse:collapse;font-size:14px;">
              ...
              <tbody>
                ...
                ${savingsData.transaction_count != null ? `<tr>
