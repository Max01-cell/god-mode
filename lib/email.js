...
export async function sendSavingsReport(lead, savingsData) {
  ...
  const notesSection = savingsData.notes ? `
    <p style="margin:20px 0 0;font-size:13px;color:#888;font-style:italic;">${savingsData.notes}</p>` : '';
        ...
        <tr>
          <td style="padding:32px 36px;">
            ...
            <table style="width:100%;border-collapse:collapse;font-size:14px;margin-bottom:8px;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="padding:10px 12px;border-bottom:1px solid #f0f0f0;text-align:right;color:#27ae60;">${fmtRate(savingsData.proposed_rate)}</td>
                </tr>
                <tr>
                  ...
                  <td style="padding:10px 12px;border-bottom:1px solid #f0f0f0;text-align:right;color:#27ae60;">${fmt(savingsData.proposed_fees)}</td>
                </tr>
            ...
            <div style="background:#f0faf4;border-left:4px solid #27ae60;border-radius:6px;padding:20px 24px;margin:28px 0;">
              ...
              <p style="margin:0;font-size:28px;font-weight:700;color:#1a1a1a;">${fmt(savingsData.monthly_savings)}<span style="font-size:14px;font-weight:400;color:#888;">/month</span></p>
              <p style="margin:4px 0 0;font-size:15px;color:#555;">${fmt(savingsData.annual_savings)} per year</p>
            </div>
        ...
        <tr>
          <td style="padding:20px 36px;border-top:1px solid #f0f0f0;">
            <p style="margin:0;font-size:12px;color:#aaa;">
              01 Payments · ISO Broker · Savings estimates are based on your submitted statement and
              interchange-plus pricing. Actual savings may vary based on card mix and transaction types.
            </p>
          </td>
        </tr>
